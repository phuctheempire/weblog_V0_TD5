<?php 
	...
	function createPost($request_values)
	{
		...
		if (count($errors) == 0) {
			$query = "INSERT INTO posts (user_id, title, slug, views, image, body, published, created_at, updated_at) VALUES(".$_SESSION['user']['id'].", '$title', '$post_slug', 0, '$featured_image', '$body', $published, now(), now())";
